...
class NodeRendererDefault extends Component {
  render() {
    ...
    const checkIfFile = node =>
      node.attributes.isFolder === true
        ? "rst__rowContents"
        : "rst__rowContentsFile";
        ...
        <div className={classnames("rst__rowWrapper", rowDirectionClass)}>
          ...
          {connectDragPreview(
            ...
            >
              ...
              >
                <i
                  className={classnames(canDrag && "fa fa-file-text ")}
                  style={{ fontSize: "20px", opacity: "0.8" }}
                />
                <i
                  className={classnames(!canDrag && "fa fa-folder")}
                  style={{ fontSize: "20px", opacity: "0.8" }}
                />
